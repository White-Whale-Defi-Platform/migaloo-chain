...
func Test_TestnetCmd(t *testing.T) {
	...
	err = genutiltest.ExecInitCmd(moduleBasic, home, encodingConfig.Marshaler)
	require.NoError(t, err)
	...
	cmd := testnetInitFilesCmd(moduleBasic, banktypes.GenesisBalancesIterator{}, genutiltypes.DefaultMessageValidator)
