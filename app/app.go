...
import (
	...
	terracustombank "github.com/White-Whale-Defi-Platform/migaloo-chain/v4/x/bank"
	custombankkeeper "github.com/White-Whale-Defi-Platform/migaloo-chain/v4/x/bank/keeper"
	...
	customquerier "github.com/White-Whale-Defi-Platform/migaloo-chain/v4/app/custom_queriers"
	appparams "github.com/White-Whale-Defi-Platform/migaloo-chain/v4/app/params"
	"github.com/White-Whale-Defi-Platform/migaloo-chain/v4/x/tokenfactory"
	tokenfactorykeeper "github.com/White-Whale-Defi-Platform/migaloo-chain/v4/x/tokenfactory/keeper"
	tokenfactorytypes "github.com/White-Whale-Defi-Platform/migaloo-chain/v4/x/tokenfactory/types"
...
func (app *MigalooApp) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
...
func (app *MigalooApp) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
	return app.mm.PreBlock(ctx)
}

// BeginBlocker application updates every begin block
func (app *MigalooApp) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	return app.mm.BeginBlock(ctx)
}

// EndBlocker application updates every end block
func (app *MigalooApp) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.mm.EndBlock(ctx)
}

// InitChainer application update at chain initialization
func (app *MigalooApp) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
...
func (app *MigalooApp) AutoCliOpts() autocli.AppOptions {
