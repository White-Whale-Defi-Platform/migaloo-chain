// this is a test helpers file that's used specifically for the global fee module, it is copied with minimal changes from Gaia.
// https://github.com/cosmos/gaia/blob/main/app/helpers/test_helpers.go
