...
$BINARY init test --home $CHAIN_DIR/$CHAINID_1 --chain-id=$CHAINID_1 --staking-bond-denom uwhale &> /dev/null
$BINARY init test --home $CHAIN_DIR/$CHAINID_2 --chain-id=$CHAINID_2 --staking-bond-denom uwhale &> /dev/null
...
$BINARY add-genesis-account $VAL1_ADDR 1000000000000uwhale --home $CHAIN_DIR/$CHAINID_1
$BINARY add-genesis-account $VAL2_ADDR 1000000000000uwhale --home $CHAIN_DIR/$CHAINID_2
$BINARY add-genesis-account $WALLET1_ADDR 1000000000000uwhale --home $CHAIN_DIR/$CHAINID_1
$BINARY add-genesis-account $WALLET2_ADDR 1000000000000uwhale --home $CHAIN_DIR/$CHAINID_2
$BINARY add-genesis-account $WALLET3_ADDR 1000000000000uwhale --vesting-amount 10000000000uwhale --vesting-start-time $(date +%s) --vesting-end-time $(($(date '+%s') + 100000023)) --home $CHAIN_DIR/$CHAINID_1
$BINARY add-genesis-account $WALLET4_ADDR 1000000000000uwhale --vesting-amount 10000000000uwhale --vesting-start-time $(date +%s) --vesting-end-time $(($(date '+%s') + 100000023)) --home $CHAIN_DIR/$CHAINID_2
$BINARY add-genesis-account $RLY1_ADDR 1000000000000uwhale --home $CHAIN_DIR/$CHAINID_1
$BINARY add-genesis-account $RLY2_ADDR 1000000000000uwhale --home $CHAIN_DIR/$CHAINID_2
