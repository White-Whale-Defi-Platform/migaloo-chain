...
migalood start --pruning=nothing  --minimum-gas-prices=0uwhale --rpc.laddr tcp://0.0.0.0:26657 --home $HOMEDIR

# ## send token
# migaloo1s5898aa2tj0yaccg3xwewv3dft3q5nf8x7fvr8
# migaloo1sxpxhzprejg5rgth0k74ws782mw00ten640zl0
# wallet migaloo10jx4vpu4uddyl7zvy24upy4kzkazxchkcd2xj5
# wallet migaloo18hs8uc8mmyj97esm33e66gk7z859f20rg40fvd
# migalood keys add $NEWKEY --keyring-backend $KEYRING --algo $KEYALGO --home $HOMEDIR
# migalood tx bank send $KEY migaloo10jx4vpu4uddyl7zvy24upy4kzkazxchkcd2xj5 100000000uwhale --keyring-backend test --chain-id test-1 --home $HOMEDIR --fees 2000uwhale -y
# migalood tx authz grant migaloo1jf65e4zye3jw9phteud8sl5llzwkulumrvzxsr send --spend-limit=1000uwhale --from=migaloo1m4lr2pmq9c6uhmqvghx57efhr2mhd6k9qh282j --keyring-backend test --chain-id test-1 --home $HOMEDIR --fees 2000uwhale -y